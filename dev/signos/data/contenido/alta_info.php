                ...
                ?>                 
                 ...
                 <input name="idx" id="idx" type="hidden"  value="<? echo $idx;?>"/>
                            ...
                            <p>
                                ...
                                <span class="field">
                                <input name="t0" id="t0" type="text" class="input-block-level" value="<? echo $t[0];?>"/>
                              </span>
                            </p>
                            ...
                            <p>
                                ...
                                <span class="field">
                                <input name="t1" id="t1" type="text" class="input-block-level" value="<? echo $t[1];?>"/>
                              </span>
                            </p>

                            
                            <p>
                                <label style="font-weight:normal;">Whatsapp (API)</label>
                                <span class="field">
                                <input name="t2" id="t2" type="text" class="input-block-level" value="<? echo $t[2];?>"/>
                              </span>
                            </p>
                            ...
                            <p>
                                ...
                                <span class="field">
                                <input name="t3" id="t3" type="text" class="input-block-level" value="<? echo $t[3];?>"/>
                              </span>
                            </p>                            
                             ...
                             <p>
                                ...
                                <span class="field">     
                                <input name="t4" id="t4" type="text" class="input-block-level" value="<? echo $t[4];?>"/><br />                             
                                </span>
                             </p>
                            ...
                            <p>
                                ...
                                <span class="field">
                                <input name="t7" id="t7" type="text" class="input-block-level" value="<? echo $t[7];?>"/>
                              </span>
                            </p>                          
                            ...
                            <p>
                                ...
                                <span class="field">
                                <input name="t8" id="t8" type="text" class="input-block-level" value="<? echo $t[8];?>"/>
                              </span>
                            </p>                          

							
                            <p>
                                <label style="font-weight:normal;">Instagram</label>
                                <span class="field">
                                <input name="t9" id="t9" type="text" class="input-block-level" value="<? echo $t[9];?>"/>
                              	</span>
                            </p>                          
                            ...
                            <p>
                                ...
                                <span class="field">
                                <input name="t10" id="t10" type="text" class="input-block-level" value="<? echo $t[10];?>"/>
                              	</span>
                            </p>                          
                            ...
                            <p>
                                ...
                                <span class="field"><input name="t11" id="t11" type="text" class="input-block-level" value="<? echo $t[11];?>"/>
                              </span>
                            </p>
                            ...
                            <p>
                                ...
                                <span class="field">
                                <input name="t12" id="t12" type="text" class="input-block-level" value="<? echo $t[12];?>" readonly/>
                              </span>
                            </p>
                            ...
                            <p>
                                ...
                                <span class="field">
                                <input name="t13" id="t13" type="text" class="input-block-level" value="<? echo $t[13];?>"/>
                              </span>
                            </p>
